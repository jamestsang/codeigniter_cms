...
class Box
{
    ...
    public function setUnderline($v)
    {
        $this->underline = $v;
    }
    ...
    public function draw($text)
    {
        ...
        foreach ($lines as $line) {
            ...
            if($this->underline){
                $lineColor = imagecolorallocate($this->im, $this->underline[0], $this->underline[1], $this->underline[2]);
                imageline ( $this->im, $xMOD , $this->box['y'] + $yAlign + ($n * $lineHeightPx) + $lineHeightPx, $xMOD + $boxWidth, $this->box['y'] + $yAlign + ($n * $lineHeightPx) + $lineHeightPx, $lineColor);
            }
